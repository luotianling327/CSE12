...
all:	Calc1 Driver1 Driver2 Calc2 
...
public:
	...
	if [ -d $(HOME)/public_html/hw6/ ]; then rm -r $(HOME)/public_html/hw6/; fi
	mkdir $(HOME)/public_html/hw6
	cp *html $(HOME)/public_html/hw6
